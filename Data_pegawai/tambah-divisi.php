...
<button onclick="location.href='tambah-karyawan.php'"
    ...
    <form method="post" style="margin-top: 1rem;">
        <input type="text" name="name_divisi" placeholder="nama divisi">
...
if (isset($_POST['submit'])) {
    ...
    $insertDivisiSql = "insert into divisi (name) values('$name')";
    $resultInsertDivisi = mysqli_query($conn, $insertDivisiSql);
    if ($resultInsertDivisi) {
